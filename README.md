...
+ 프로젝트명: 과외중개사이트 제작
+ Github 및 포트폴리오 주소: 
+ 수행기간: 2022년 03월 29일 ~ 2022년 05월 16일
...
+ 프로젝트 참여소감 
 - 세미프로젝트 참여하면서 홈페이지 한 개를 만들기 위해서 여러 명이 협동하면, UI 화면, 클래스 다이아그램, 유스케이스 등 문서작성을 하면서 기능을 기획했던 부분을 오류발생을 처리하면서 소모되는 시간을 예상보다 길어져서 계획대로 기능 구현을 더 섬세하게 구현하지 못한 부분도 있었고 최종적으로 문서 작업도 제대로 못했던 것 같아서 아쉬웠다. 다음 파이널 프로젝트때는 아쉬운 부분이 없도록 기능구현을 진행할 것이다. 

+ 
![image](https://user-images.githubusercontent.com/98323305/195303933-92d58e89-0330-4722-8a11-1fdfaa4208c9.png)
